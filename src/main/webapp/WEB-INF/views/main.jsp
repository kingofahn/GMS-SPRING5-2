...
<%--     <link href="${ctx}/other_resources/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/other_resources/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <link href="${ctx}/other_resources/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" /> --%>
